...
-- Volcando datos para la tabla lieison_unitee.adjunto: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla lieison_unitee.compras: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla lieison_unitee.historial_compra: 3 rows
...
INSERT INTO `login` (`id_login`, `user`, `password`, `status`, `password_state`, `date`, `last_date`) VALUES
	(1, 'admin', '9cf5164205312e8b6be39ec47f9f1d8af556fdc950d01b5d4ca845e190d06f85f2f76bebcc30145a0401462d3f537f6a0793eaaf6805c0c3d188f5c883367332J8eczdg0jNOFwX9/epIz0yMp8lNPLsx6kjezpBrvcN0=', 1, 1, '2015-07-28 15:56:56', '2015-09-12 08:09:09'),
	(2, 'geabenitez', '7fe73bb21265da4d14f700c2aec1cb3a0f6ed54013592b9b4af88da69295702b6ec181a55caf445a5d0294f0aad96344320ce60fed0d55b0f1ae69defad781f9lXMaQgOLbJwQ/KtLN0kkcIwt47w5d/dadAA3nTGOyPA=', 1, 1, '2015-08-03 19:33:18', '2015-09-11 10:09:58'),
	...
	(9, 'nestor', 'e73b1fa9efed11c3002a7f73435edeb42836c9a9fed567a9fdcfe4968ece364a3618d8daa5a572239336f0f7452561ec8ceeb241127d868b0496580028949798+k+30UUQVYsczTLU5UEnIPL8Dnqi97hgeTaQfOCGfIs=', 1, 0, '2015-08-13 22:08:30', '2015-09-11 09:09:10'),
...
-- Volcando datos para la tabla lieison_unitee.metadata: 3 rows
...
-- Volcando datos para la tabla lieison_unitee.notification: 5 rows
...
INSERT INTO `notification` (`id_notification`, `id_object`, `table_object`, `id_roles`, `id_user`, `alert`, `description`, `last_date`, `redirect`, `status`, `read`, `icon`) VALUES
	(34, 21, 'producto', '1', NULL, 'label-warning', 'Producto producto 4 Terminado  (test)[Cantidad en inventario : 0]', '2015-09-10 15:09:55', 'compra=new_compra?i=21&n=producto 4&c=negro', 1, 0, 'icon-file'),
	(31, 22, 'producto', '1', NULL, 'label-warning', 'Producto Tela Seda Terminado  (SEDA DE COLOR)[Cantidad en inventario : 2]', '2015-09-09 09:09:51', 'compra=new_compra?i=22&n=Tela Seda&c=negro', 1, 1, 'icon-file'),
	(32, 25, 'producto', '1', NULL, 'label-warning', 'Producto tela de algodon Terminado  (tela)[Cantidad en inventario : 0]', '2015-09-09 09:09:53', 'compra=new_compra?i=25&n=tela de algodon&c=marron', 0, 0, 'icon-file'),
	(33, 26, 'producto', '1', NULL, 'label-warning', 'Producto tela de algodon Terminado  (SEDA DE COLOR X+Y)[Cantidad en inventario : 300]', '2015-09-09 09:09:56', 'compra=new_compra?i=26&n=tela de algodon&c=negro', 1, 1, 'icon-file'),
	(30, 24, 'producto', '1', NULL, 'label-warning', 'Producto cubierta de algodon Terminado  (Descripcion)[Cantidad en inventario : 0]', '2015-09-09 09:09:45', 'compra=new_compra?i=24&n=cubierta de algodon&c=negro', 0, 0, 'icon-file');
...
INSERT INTO `producto` (`id_producto`, `id_unidad`, `id_color`, `nombre`, `descripcion`, `sku`, `margen`, `precio`, `precio_est_unidad`, `cantidad`, `date`, `status`) VALUES
	(17, 1, 3, 'Tela Seda', '        SEDA DE COLOR ROJO ', 'tel-17-20150826', '25', 45, 1.5, 500, '2015-08-26 04:08:05', 1),
	(20, 1, 3, 'producto 4', 'test', 'pro-19-20150827', '20', 12, 20, 980, '2015-08-27 19:08:52', 1),
	(21, 1, 2, 'producto 4', 'test', 'pro-21-20150827', '45', 12, 9, 24, '2015-08-27 19:08:13', 1),
	(22, 2, 2, 'Tela Seda', 'SEDA DE COLOR', 'tel-22-20150827', '892', 0, 672, 0, '2015-08-27 21:08:47', 1),
	(24, 2, 2, 'cubierta de algodon', 'Descripcion', 'El -24-20150827', '2', 222, 0, 111, '2015-08-27 17:08:35', 1),
	(25, 1, 11, 'tela de algodon', 'tela', 'tel-25-20150829', '50', 12, 1, 171, '2015-08-29 11:08:04', 1),
