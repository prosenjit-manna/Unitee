                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <textarea id="txt_descripcion" name="txt_descripcion" rows="4" cols="50" class="form-control input-circle" placeholder="Descripcion de la Empresa"><?php echo $data->descripcion; ?></textarea>
                                        </div>
                                    </div>
