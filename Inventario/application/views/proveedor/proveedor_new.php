												...
												<div class="row">
													<div class="col-md-6">
													   ...
													   <label class="control-label col-md-2">Empresa</label>
														...
														<label class="control-label col-md-2">Tel茅fono</label>
														<div class="form-group col-md-10">
													...
													<div class="col-md-6">
														...
														<div class="form-group col-md-9">
                                                                                                                ...
                                                                                                                <label class="control-label col-md-3">Direcci贸n 1</label>
														<div class="form-group col-md-9">
                                                                                                                    <input required="" type="text" id="" name="" class="form-control input-circle" placeholder="Nombre de la Direccion 1">
														</div>
                                                                                                                <label class="control-label col-md-3">Direcci贸n 2</label>
														<div class="form-group col-md-9">
