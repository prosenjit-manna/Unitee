...
-- Volcando estructura para tabla nockup_inventario.namespaces
...
-- Volcando datos para la tabla nockup_inventario.namespaces: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `namespaces` DISABLE KEYS */;
REPLACE INTO `namespaces` (`id_namespace`, `name`, `start`) VALUES
	(1, 'opciones generales', 1),
	(2, 'Namespace de prueba', 2);
...
-- Volcando datos para la tabla nockup_inventario.seccion: ~2 rows (aproximadamente)
...
REPLACE INTO `seccion` (`id_seccion`, `id_namespace`, `sub_seccion`, `roles`, `name`, `icon`, `start`, `status`, `complement`) VALUES
	...
	(4, 2, NULL, '1', 'Seccion 1', 'icon-folder', 1, 1, NULL),
	(5, 2, 4, '1', 'Sub seccion', 'icon-folder', 1, 1, NULL),
	(6, 2, NULL, '1', 'Seccion 2', 'icon-folder', 1, 1, NULL),
	(7, NULL, NULL, '1', 'no namespace', 'icon-folder', 1, 1, NULL);
...
REPLACE INTO `sidebar` (`id_sidebar`, `id_seccion`, `roles`, `name`, `model_dir`, `model`, `type`, `status`, `icon`, `start`, `complement`) VALUES
	(1, 1, '0', 'Main', '', '', 'system', 1, 'fa fa-tachometer', 1, NULL),
	(3, 5, '1', 'Link 1', 'user', 'user_profile', 'plugin', 1, 'icon-folder', 2, NULL),
	(4, 5, '1', 'Link 2', NULL, NULL, 'plugin', 1, 'icon-folder', 1, NULL),
	(5, 5, '1', 'Link 3 out', NULL, NULL, 'plugin', 1, 'icon-folder', 3, NULL),
	(6, 6, '1', 'Link 4', NULL, NULL, 'plugin', 1, 'icon-folder', 1, NULL),
	(7, 7, '1', 'Say Hello', NULL, NULL, 'plugin', 1, 'icon-folder', 1, NULL);
...
REPLACE INTO `user` (`id_user`, `id_login`, `id_rol`, `nombres`, `apellidos`, `email`, `avatar`) VALUES
	(1, 1, 1, 'Rolando Antonio', 'Arriaza Marroquin', 'admin@unitee.com', '6bvGUe3N.jpg'),
