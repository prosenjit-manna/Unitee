...
-- Volcando datos para la tabla lieison_unitee.adjunto: ~11 rows (aproximadamente)
...
INSERT INTO `adjunto` (`id_adjunto`, `adjunto`, `tipo`, `comentario`, `fecha`) VALUES
	...
	(26, '["{\\"name\\":[\\"rolando.jpg\\"],\\"document\\":\\"ecbe8fade14d9f0e0d61b6c6ca1c69d2\\",\\"directory\\":\\"1ai9cFUX \\"}","{\\"name\\":[\\"1185842_10152174126608222_557578996_n.jpg\\"],\\"document\\":\\"8354dfb45bef8b09e0f568399a351d7f\\",\\"directory\\":\\"1ai9cFUX \\"}","{\\"name\\":[\\"componente1.docx\\"],\\"document\\":\\"a0af0401658bfbf69076c66fb51f85e3\\",\\"directory\\":\\"1ai9cFUX \\"}"]', 'compras', 'Cod:fASKjt5y', '2015-09-22 16:09:55'),
	(30, '["{\\"file\\":\\"xrwOoPIu\\",\\"name\\":\\"CMKP3ZZXAAExu3A.jpg\\",\\"directory\\":\\"48675192\\"}","{\\"file\\":\\"bjQORWdF\\",\\"name\\":\\"ea1.png\\",\\"directory\\":\\"48675192\\"}"]', 'cliente', 'Cod:VSIZdGFp', '2015-09-25 11:09:09'),
	(32, '["{\\"file\\":\\"c7vXMVg9\\",\\"name\\":\\"ea1.png\\",\\"directory\\":\\"14852609\\"}"]', 'cliente', 'Cod:ZUotQsgv', '2015-09-25 11:09:37'),
	(33, '["{\\"file\\":\\"svhKEoat\\",\\"name\\":\\"\\",\\"directory\\":\\"93861270\\"}"]', 'cliente', 'Cod:szpF9wXy', '2015-09-27 16:09:41');
...
-- Volcando datos para la tabla lieison_unitee.cliente: 2 rows
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` (`id_cliente`, `id_direccion`, `id_contacto`, `nombre`, `descripcion`, `id_adjunto`, `tipo`, `nit`, `iva`, `fecha`) VALUES
	(1, 46, 43, 'CONTABLE MACHUCA', 'BUENO ES CONTABLE', 32, 'Persona Natural', '1222-334445-432-3', '233444-3', '2015-09-25'),
	(2, 47, 44, 'Rolando Arriaza', 'es un buen cliente', 33, 'Persona Natural', '2223-222211-221-2', '122333-2', '2015-09-27');
...
-- Volcando datos para la tabla lieison_unitee.compras: ~5 rows (aproximadamente)
...
INSERT INTO `compras` (`id_compras`, `id_proveedor`, `precio_total`, `ref_factura`, `PO`, `id_adjunto`, `id_user`, `date`) VALUES
	...
	(41, 36, 40, 'ROLANDO', '203', 26, 1, '2015-09-22 16:09:56'),
	(42, 34, 120, '1111', '1222', NULL, 1, '2015-09-22 16:09:22');
/*!40000 ALTER TABLE `compras` ENABLE KEYS */;

-- Volcando datos para la tabla lieison_unitee.contacto: ~35 rows (aproximadamente)
...
INSERT INTO `contacto` (`id_contacto`, `tel1`, `tel2`, `fax`, `correo`, `nombre`) VALUES
	...
	(39, '22224444', '78451258', '2125451', 'pedro@master.com', 'Pedro'),
...
-- Volcando datos para la tabla lieison_unitee.direccion: ~35 rows (aproximadamente)
...
-- Volcando datos para la tabla lieison_unitee.historial_compra: 15 rows
...
INSERT INTO `login` (`id_login`, `user`, `password`, `status`, `password_state`, `date`, `last_date`) VALUES
	(1, 'admin', '9cf5164205312e8b6be39ec47f9f1d8af556fdc950d01b5d4ca845e190d06f85f2f76bebcc30145a0401462d3f537f6a0793eaaf6805c0c3d188f5c883367332J8eczdg0jNOFwX9/epIz0yMp8lNPLsx6kjezpBrvcN0=', 1, 1, '2015-07-28 15:56:56', '2015-09-28 08:09:18'),
	(2, 'geabenitez', '7fe73bb21265da4d14f700c2aec1cb3a0f6ed54013592b9b4af88da69295702b6ec181a55caf445a5d0294f0aad96344320ce60fed0d55b0f1ae69defad781f9lXMaQgOLbJwQ/KtLN0kkcIwt47w5d/dadAA3nTGOyPA=', 1, 1, '2015-08-03 19:33:18', '2015-09-19 09:09:20'),
	(9, 'nestor', 'e73b1fa9efed11c3002a7f73435edeb42836c9a9fed567a9fdcfe4968ece364a3618d8daa5a572239336f0f7452561ec8ceeb241127d868b0496580028949798+k+30UUQVYsczTLU5UEnIPL8Dnqi97hgeTaQfOCGfIs=', 1, 0, '2015-08-13 22:08:30', '2015-09-25 09:09:43'),
	...
	(19, 'carleto', '74c1afcfd187558d48cacacaa27d9f15172042945aa4d22b2b1fa8a1dd320cb56cee5d47d20b8dcefeb4eb342e66566e960546983bb293d82a4f9b0f0a451e4eOU/PCdbU27kuwUU/pWaXpMmM7CfXl+asyJo3PK27qxM=', 1, 1, '2015-09-17 18:09:10', '2015-09-23 22:09:04');
...
INSERT INTO `producto` (`id_producto`, `id_unidad`, `id_color`, `nombre`, `descripcion`, `sku`, `margen`, `precio`, `precio_est_unidad`, `cantidad`, `date`, `status`) VALUES
	(17, 1, 3, 'Tela Seda', '        SEDA DE COLOR ROJO ', 'tel-17-20150826', '25', 1.2, 1.5, 924, '2015-08-26 04:08:05', 1),
	(20, 1, 3, 'producto 4', 'test', 'pro-19-20150827', '20', 1.2, 20, 1126, '2015-08-27 19:08:52', 1),
	(21, 1, 2, 'producto 4', 'test', 'pro-21-20150827', '45', 1.2, 9, 458, '2015-08-27 19:08:13', 1),
	(22, 2, 2, 'Tela Seda', 'SEDA DE COLOR', 'tel-22-20150827', '10', 40, 672, 226, '2015-08-27 21:08:47', 1),
	(24, 2, 2, 'cubierta de algodon', 'Descripcion', 'El -24-20150827', '2', 1.2, 0, 294, '2015-08-27 17:08:35', 1),
	(25, 1, 11, 'tela de algodon', 'tela', 'tel-25-20150829', '50', 1.2, 1, 488, '2015-08-29 11:08:04', 1),
	(26, 1, 2, 'tela de algodon', 'SEDA DE COLOR X+Y', 'TEL-26-20150908', '900', 120, 200, 224, '2015-09-08 00:09:51', 1);
/*!40000 ALTER TABLE `producto` ENABLE KEYS */;

-- Volcando datos para la tabla lieison_unitee.proveedor: ~29 rows (aproximadamente)
...
INSERT INTO `proveedor` (`id_proveedor`, `codigo`, `nombre`, `id_direccion`, `id_contacto`, `descripcion`, `fecha`) VALUES
	...
	(37, 'PROV1461Mas', 'Master', 42, 39, 'Descripcion prueba porque se cambio el text area', '2015-09-21 22:09:57');
...
INSERT INTO `sidebar` (`id_sidebar`, `id_seccion`, `roles`, `name`, `model_dir`, `model`, `routes`, `type`, `status`, `icon`, `start`, `complement`, `operations`) VALUES
	...
	(15, 11, '1', 'Nuevo Articulo', NULL, NULL, NULL, 'plugin', 1, 'icon-plus', 1, NULL, NULL),
	(16, 11, '1', 'Ver Articulos', NULL, NULL, NULL, 'plugin', 1, 'icon-eye-open', 2, NULL, NULL),
...
INSERT INTO `user` (`id_user`, `id_login`, `id_rol`, `nombres`, `apellidos`, `email`, `avatar`) VALUES
	...
	(14, 19, 4, 'carleto', 'ramirez', 'rmarroquin@lieison.com', NULL);
