...
INSERT INTO `login` (`id_login`, `user`, `password`, `status`, `password_state`, `date`, `last_date`) VALUES
	(1, 'admin', '9cf5164205312e8b6be39ec47f9f1d8af556fdc950d01b5d4ca845e190d06f85f2f76bebcc30145a0401462d3f537f6a0793eaaf6805c0c3d188f5c883367332J8eczdg0jNOFwX9/epIz0yMp8lNPLsx6kjezpBrvcN0=', 1, 1, '2015-07-28 15:56:56', '2015-09-19 23:09:00'),
...
INSERT INTO `sidebar` (`id_sidebar`, `id_seccion`, `roles`, `name`, `model_dir`, `model`, `type`, `status`, `icon`, `start`, `complement`, `operations`) VALUES
	...
	(23, 15, '1', 'Nuevo Cliente', 'clientes', 'new_cliente', 'plugin', 1, 'icon-plus', 1, NULL, NULL),
