...
-- Volcando datos para la tabla lieison_unitee.adjunto: ~8 rows (aproximadamente)
...
INSERT INTO `adjunto` (`id_adjunto`, `adjunto`, `tipo`, `comentario`, `fecha`) VALUES
	...
	(25, '["{\\"name\\":[\\"CorreosElectronicos.txt\\"],\\"document\\":\\"244de40495510395056fbf2da3f7de25\\",\\"directory\\":\\"TeC2XFZp \\"}"]', 'compras', 'Cod:uKiU2aWQ', '2015-09-19 10:09:21');
...
-- Volcando datos para la tabla lieison_unitee.cliente: 0 rows
...
INSERT INTO `compras` (`id_compras`, `id_proveedor`, `precio_total`, `ref_factura`, `PO`, `id_adjunto`, `id_user`, `date`) VALUES
	...
	(38, 13, 23, '123456', '145', NULL, 1, '2015-09-18 10:09:40'),
	(39, 32, 2, '666', '666', 25, 1, '2015-09-19 10:09:21');
/*!40000 ALTER TABLE `compras` ENABLE KEYS */;

-- Volcando datos para la tabla lieison_unitee.contacto: ~30 rows (aproximadamente)
...
-- Volcando datos para la tabla lieison_unitee.direccion: ~30 rows (aproximadamente)
...
-- Volcando datos para la tabla lieison_unitee.historial_compra: 8 rows
...
INSERT INTO `login` (`id_login`, `user`, `password`, `status`, `password_state`, `date`, `last_date`) VALUES
	(1, 'admin', '9cf5164205312e8b6be39ec47f9f1d8af556fdc950d01b5d4ca845e190d06f85f2f76bebcc30145a0401462d3f537f6a0793eaaf6805c0c3d188f5c883367332J8eczdg0jNOFwX9/epIz0yMp8lNPLsx6kjezpBrvcN0=', 1, 1, '2015-07-28 15:56:56', '2015-09-20 21:09:26'),
	...
	(9, 'nestor', 'e73b1fa9efed11c3002a7f73435edeb42836c9a9fed567a9fdcfe4968ece364a3618d8daa5a572239336f0f7452561ec8ceeb241127d868b0496580028949798+k+30UUQVYsczTLU5UEnIPL8Dnqi97hgeTaQfOCGfIs=', 1, 0, '2015-08-13 22:08:30', '2015-09-18 08:09:58'),
	...
	(19, 'carleto', '74c1afcfd187558d48cacacaa27d9f15172042945aa4d22b2b1fa8a1dd320cb56cee5d47d20b8dcefeb4eb342e66566e960546983bb293d82a4f9b0f0a451e4eOU/PCdbU27kuwUU/pWaXpMmM7CfXl+asyJo3PK27qxM=', 1, 1, '2015-09-17 18:09:10', '2015-09-17 14:09:09');
...
INSERT INTO `notification` (`id_notification`, `id_object`, `table_object`, `id_roles`, `id_user`, `alert`, `description`, `last_date`, `redirect`, `status`, `read`, `icon`) VALUES
	(40, 22, 'producto', '1', NULL, 'label-warning', 'Producto Tela Seda Terminado  , [Color: negro][Cantidad en inventario : 14]', '2015-09-17 10:09:42', 'compra=new_compra?i=22&n=Tela Seda&c=negro', 1, 0, 'icon-file'),
	(41, 26, 'producto', '1', NULL, 'label-warning', 'Producto tela de algodon Terminado  , [Color: negro][Cantidad en inventario : 12]', '2015-09-17 10:09:44', 'compra=new_compra?i=26&n=tela de algodon&c=negro', 1, 0, 'icon-file');
...
INSERT INTO `producto` (`id_producto`, `id_unidad`, `id_color`, `nombre`, `descripcion`, `sku`, `margen`, `precio`, `precio_est_unidad`, `cantidad`, `date`, `status`) VALUES
	(17, 1, 3, 'Tela Seda', '        SEDA DE COLOR ROJO ', 'tel-17-20150826', '25', 12, 1.5, 912, '2015-08-26 04:08:05', 1),
	(20, 1, 3, 'producto 4', 'test', 'pro-19-20150827', '20', 23, 20, 1114, '2015-08-27 19:08:52', 1),
	(21, 1, 2, 'producto 4', 'test', 'pro-21-20150827', '45', 2, 9, 446, '2015-08-27 19:08:13', 1),
	(22, 2, 2, 'Tela Seda', 'SEDA DE COLOR', 'tel-22-20150827', '892', 0.05, 672, 14, '2015-08-27 21:08:47', 1),
	(24, 2, 2, 'cubierta de algodon', 'Descripcion', 'El -24-20150827', '2', 12, 0, 282, '2015-08-27 17:08:35', 1),
	(25, 1, 11, 'tela de algodon', 'tela', 'tel-25-20150829', '50', 12, 1, 476, '2015-08-29 11:08:04', 1),
	(26, 1, 2, 'tela de algodon', 'SEDA DE COLOR X+Y', 'TEL-26-20150908', '900', 12, 200, 12, '2015-09-08 00:09:51', 1);
/*!40000 ALTER TABLE `producto` ENABLE KEYS */;

-- Volcando datos para la tabla lieison_unitee.proveedor: ~28 rows (aproximadamente)
...
INSERT INTO `sidebar` (`id_sidebar`, `id_seccion`, `roles`, `name`, `model_dir`, `model`, `routes`, `type`, `status`, `icon`, `start`, `complement`, `operations`) VALUES
	(1, 1, '0', 'Pagina Principal', '', '', NULL, 'system', 1, 'icon-dashboard', 1, NULL, NULL),
	...
	(13, 10, '1', 'Nuevas Compras', 'compra', 'new_compra', NULL, 'plugin', 1, 'icon-plus', 1, NULL, NULL),
	(14, 10, '1', 'Ver Compras', 'compra', 'view_compra', NULL, 'plugin', 1, 'icon-eye-open', 2, NULL, NULL),
	...
	(23, 15, '1', 'Nuevo Cliente', 'clientes', 'new_cliente', NULL, 'plugin', 1, 'icon-plus', 1, NULL, NULL),
	(24, 15, '1', 'Ver Clientes', NULL, NULL, NULL, 'plugin', 1, 'icon-eye-open', 2, NULL, NULL),
