var TableAdvanced = function () {
    ...
    var initTableFixed = function () {
        var table = $('#table_fixed');

        /* Formatting function for row expanded details */
        function fnFormatDetails(oTable, nTr) {
            var aData = oTable.fnGetData(nTr);
            var sOut = '<table>';
            sOut += '<tr><td>Version:</td><td> 1.0 </td></tr>';
            sOut += '<tr><td>Tipo:</td><td> Plugin </td></tr>';
            sOut += '<tr><td>Ultima Actualizacion:</td><td> Martes 25 Julio del 2015 </td></tr>';
        ...
        var tableWrapper = $('#table_fixed_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
        var tableColumnToggler = $('#table_fixed_column_toggler');
    ...
    var initTable4 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            sOut += '<tr><td>Engine version:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td>CSS grade:</td><td>' + aData[4] + '</td></tr>';
            sOut += '<tr><td>Others:</td><td><i class="icon-upload-alt"></i> Actualizar</td></tr>';
            sOut += '</table>';
