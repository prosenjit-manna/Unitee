...
<section class="fpd-main-bar fpd-clearfix fpd-primary-bg-color">
	...
	<div class="fpd-left">
		...
		<div class="fpd-btn fpd-primary-text-color" data-context="adds">
            ...
            <div class="fpd-btn fpd-primary-text-color" style="display: inline-block;" data-context="products">
		...
		<div class="fpd-dialog-content">
			...
			<div class="fpd-content-products ">
				...
				<div class="fpd-content-main">
                            ...
                            <div style="height:calc(100% - 40px);line-height:3em;overflow:auto;padding:5px;" class="form-group">
                                
                               
                                <select onchange="style_select();" id="cmd_articulos" class="form-control">
                                    <option value="-1" selected>Seleccione un estilo</option>
                                </select>
                                <br>
                                <div id="cmd_seccion_articulos" class="form-group">
              
                                </div>
             
                            </div>
                                </div>
                                    <div style="display: none;" class="fpd-grid fpd-grid-contain fpd-padding fpd-dynamic-columns"></div>
