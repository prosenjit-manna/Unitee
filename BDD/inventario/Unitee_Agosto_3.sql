...
-- Volcando datos para la tabla nockup_inventario.login: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `login` DISABLE KEYS */;
REPLACE INTO `login` (`id_login`, `user`, `password`, `status`, `date`, `last_date`) VALUES
	(1, 'admin', '600ef7c16c6cfbe31211efce0d039e36cad30db50b8aa48cc963fcf4aab91cd51d83064f0bf466231004ab8a10abf6e2ec3fafcc18ecb3b3b044c3054a81f69bRXelF72tkUnfVWgAbpWi0CgvE/3Ctkhal5h8Q5EQ+hU=', 1, '2015-07-28 15:56:56', '2015-07-28 15:56:59');
...
-- Volcando datos para la tabla nockup_inventario.roles: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;


-- Volcando estructura para tabla nockup_inventario.sidebar_left
CREATE TABLE IF NOT EXISTS `sidebar_left` (
  `id_lsidebar` int(11) NOT NULL AUTO_INCREMENT,
  `name` text,
  `model_dir` text,
  `model` text,
  ...
  PRIMARY KEY (`id_lsidebar`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla nockup_inventario.sidebar_left: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `sidebar_left` DISABLE KEYS */;
/*!40000 ALTER TABLE `sidebar_left` ENABLE KEYS */;
...
REPLACE INTO `user` (`id_user`, `id_login`, `nombres`, `apellidos`, `id_rol`, `email`) VALUES
	(1, 1, 'Administrador', 'Unitee', 1, 'admin@unitee.com');
