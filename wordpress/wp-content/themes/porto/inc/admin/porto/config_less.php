...
@body_mobile_font_size_scale: <?php echo ((float)$b['body-mobile-font']['font-size'] / (float)$b['body-font']['font-size']) ?>;
@body_mobile_line_height_scale: <?php echo ((float)$b['body-mobile-font']['line-height'] / (float)$b['body-font']['line-height']) ?>;
