                    ...
                    <td colspan="6" class="actions">
                        ...
                        <?php if ( version_compare($porto_woo_version, '2.3', '<') ) : ?>
                            <div class="actions pt-right">
                                <input type="submit" class="btn btn-default btn-lg" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button btn-lg alt wc-forward" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
                            </div>

                            <?php do_action( 'woocommerce_proceed_to_checkout' ); ?>
                        <?php else : ?>
                            <div class="cart-actions pt-right">
                                <input type="submit" class="btn btn-default btn-lg" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" />
