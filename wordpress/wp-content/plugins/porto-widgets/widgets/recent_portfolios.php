...
class Porto_Recent_Portfolios_Widget extends WP_Widget {
    ...
    function Porto_Recent_Portfolios_Widget()
    {
        ...
        $this->WP_Widget('recent_portfolios-widget', __('Porto: Recent Portfolios', 'porto-widgets'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        if ($portfolios->have_posts()) :
            ...
            <div class="row<?php if ($view == 'small') echo ' gallery-row' ?>">
                <div<?php if ($number > $items) : ?> class="portfolio-carousel owl-carousel" data-cols-lg="1" data-cols-md="3" data-cols-sm="2" data-single="<?php echo $view == 'small' ? '1' : '0' ?>"<?php endif; ?>>
                    <?php
                    $count = 0;
